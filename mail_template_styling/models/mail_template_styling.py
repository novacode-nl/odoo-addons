...
class MailTemplate(models.Model):
    ...
    def generate_email(self, res_ids, fields=None):
        ...
        # force body_html to be returned
        fields=None
        results = super(MailTemplate, self).generate_email(res_ids, fields)

        # preview in a mail.template
        if self._context.get('template_id') and self._context['active_model'] == 'mail.template':
            ...
            if self.strip_inline_style:
                ...
                body_html = html_sanitize(body_html,
                                          sanitize_tags=False,
            ...
            # Apply changes to all email templates
